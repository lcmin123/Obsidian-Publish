...
This is your first note. You'll find it in the [`notes/`](https://github.com/lcmin123/Obsidian-Publish/tree/main/_notes) directory. 
...
Dashes and underscores in file names are supported, and may be omitted in the bracket link syntax. As an example, the `your-first-note.md` file can be linked to with [[your first note]] or [[Digital Garden]], or even [[yOuR-FiRsT Note]].
